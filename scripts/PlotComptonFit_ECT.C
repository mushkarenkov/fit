...
//   Fit::TFit fit("plot.par");
  ...
  // Plot Sigma2x
//   PlotSigma2x_NoFit();
//   PlotSigma2x_FitTo_xsTAPS_xsLARA_Sigma2xCB();
//   PlotSigma2x_FitTo_Sigma3LEGS_Sigma2xCB();
  
  // Plot Sigma3
//   PlotSigma3_NoFit();
//   PlotSigma3_FitTo_Sigma3LEGS_Sigma2xCB();
  
  // Plot cross sections
//   PlotCS_NoFit();
//   PlotCS_FitTo_xsTAPS_xsLARA_Sigma2xCB();
  PlotCS_FitTo_Sigma3LEGS_Sigma2xCB();
...
void PlotCS_NoFit()
{
  ...
  // Lvov
  Fit::Point_t point3(5);
  point3[2] = 12.;
  point3[3] = 1.6;
  point3[4] = -38.7;
  
  Fit::Point_t point33(5);
  point33[2] = 11.2.;
  point33[3] = 3.9;
  point33[4] = -39.47;
...
//   Double_t eg[12] = {333.8,323.8,310.1,298.2,286.5,275.6,265.1,254.1,244.8,234.7,224.3,213.1};
  ...
  for (Int_t i=0; i<250; ++i)
  {
    ...
    stringstream ss;
    TString egamma;
    point1[1] = point2[1] = point3[1] = point33[1] = eg;
    ss << eg; ss >> egamma;
    TCanvas *canv = PlotCS(eg,
			     point1, "PascalutsaCS", 50, "Pascalutsa (LP)",
			     point1, "PasquiniCS", 10, "Pasquini (LP)",
			     point33, "LvovCS", 50, "Lvov (LP)",
			     point2, "PascalutsaCS", 50, "Pascalutsa (PDV)",
			     point2, "PasquiniCS", 10, "Pasquini (PDV)",
			     point3, "LvovCS", 50, "Lvov (PDV)"
			    );
...
void PlotSigma2x_NoFit()
{
  ...
  TCanvas *canv = PlotSigma2x(eg,
			     point1, "PascalutsaSigma2x", 50, "Pascalutsa (LP)",
			     point1, "PasquiniSigma2x", 15, "Pasquini (LP)",
			     point_dummy, "", 0, "",
			     point2, "PascalutsaSigma2x", 50, "Pascalutsa (PDV)",
			     point2, "PasquiniSigma2x", 15, "Pasquini (PDV)",
			     point_dummy, "", 0, ""
			    );
...
//__________________________________________________________________________________
void PlotCS_FitTo_Sigma3LEGS_Sigma2xCB()
{
  // Pascalutsa (direct fit, wihtout lin.approx)
  Fit::Point_t point1(8);
  point1[2] = 16.3;
  point1[3] = 0.;
  point1[4] = -5.3;
...
//   Double_t eg[12] = {333.8,323.8,310.1,298.2,286.5,275.6,265.1,254.1,244.8,234.7,224.3,213.1};
  ...
  for (Int_t i=0; i<250; ++i)
  {
    ...
    if (canv) canv->SaveAs("CS_FitTo_Sigma3LEGS_Sigma2xCB_"+egamma+"MeV.pdf");
//     file.cd();
//     canv->SetName("CS"+egamma+"MeV")
//     canv->Write();
  }
...
//__________________________________________________________________________________
void PlotSigma2x_FitTo_Sigma3LEGS_Sigma2xCB()
{
  // Pascalutsa (direct fit, wihtout lin.approx)
  Fit::Point_t point1(8);
  point1[2] = 16.3;
  ...
  ss << eg; ss >> egamma;
  TCanvas *canv = PlotSigma2x(eg,
			     point1, "PascalutsaSigma2x", 50, "Pascalutsa",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
  ...
  canv->SaveAs("Sigma2x_FitTo_Sigma3LEGS_Sigma2xCB_"+egamma+"MeV.pdf");
  
}

//__________________________________________________________________________________
void PlotCS_FitTo_xsTAPS_xsLARA_Sigma2xCB()
{
  // Pascalutsa
  Fit::Point_t point1(8);
  point1[2] = 12.6;
...
//   Double_t eg[12] = {333.8,323.8,310.1,298.2,286.5,275.6,265.1,254.1,244.8,234.7,224.3,213.1};
  ...
  for (Int_t i=0; i<250; ++i)
  {
    ...
    if (canv) canv->SaveAs("CS_FitAll_"+egamma+"MeV.pdf");
//     file.cd();
//     canv->SetName("CS"+egamma+"MeV")
//     canv->Write();
  }
...
//__________________________________________________________________________________
void PlotSigma2x_FitTo_xsTAPS_xsLARA_Sigma2xCB()
{
  // Pascalutsa
  Fit::Point_t point1(8);
  point1[2] = 12.6;
  ...
  TCanvas *canv = PlotSigma2x(eg,
			     point1, "PascalutsaSigma2x", 50, "Pascalutsa",
			     point2, "PasquiniSigma2x", 50, "Pasquini",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, ""
			    );
  canv->SaveAs("Sigma2x_FitAll_"+egamma+"MeV.pdf");
}

//__________________________________________________________________________________
void PlotSigma3_FitTo_Sigma3LEGS_Sigma2xCB()
{
  // Pascalutsa
  Fit::Point_t point1(8);
  point1[2] = 16.3;
  ...
  for (Int_t i=0; i<12; ++i)
  {
    ...
    TCanvas *canv = PlotSigma3(eg[i],
			     point1, "PascalutsaSigma3", 50, "Pascalutsa",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
			     point_dummy, "", 0, "",
    ...
    canv->SaveAs("Sigma3_Sigma3LEGS_Sigma2xCB_"+egamma+"MeV.pdf");
  }
		   ...
		   )
{
  ...
  // Legend
  TLegend *lg = new TLegend(0.55,0.65,0.89,0.89,"","brNDC");
  lg->SetLineColor(0);
  lg->SetTextSize(0.03);
...
//   canv->SetRightMargin(0.225);
  ...
  // Legend
  TLegend *lg = new TLegend(0.78,0.5,1.,0.89,"","brNDC");
  lg->SetLineColor(0);
  lg->SetTextSize(0.03);
